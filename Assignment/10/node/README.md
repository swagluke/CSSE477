...
This project is built upon on grpc's Node example code. I added extra PrintCurrentTimePython function in both Node client side and python server side so by calling the function, it will return the current time.
